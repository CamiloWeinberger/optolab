...
class VTUNet(nn.Module):
    def __init__(self, num_classes=1, embed_dim=96, win_size=8):
        super(VTUNet, self).__init__()
        self.num_classes = num_classes
        self.embed_dim = embed_dim
        self.win_size = (win_size, win_size, win_size)

        self.swin_unet = SwinTransformerSys3D(img_size=(16, 256, 256),
                                            patch_size=(1, 8, 8),
                                            in_chans=1,
