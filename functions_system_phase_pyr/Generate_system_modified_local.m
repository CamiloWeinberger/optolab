function [out] = Generate_system_modified_local
...
iMat    = interaction_localNorm(ngs,tel,pyr,zernRec.modes); %pyr 2 zern
...
out.pyr2zern=pyr2zern(2:end,:);
out.ph2zern=ph2zern(2:end,:);
out.I_0=I_0;
out.pyr2kl = pyr2kl;
out.ph2kl = ph2kl;
out.zernRec = zernRec;
